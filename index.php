  ...
  <div class="w3-main" style="margin-left:250px">
    ...
    <header class="w3-container w3-xlarge">
      ...
      <p class="w3-right">
        ...
        <!-- Find icon -->
        <a href="filesearch.html" class="w3-bar-item w3-button  w3-right" onclick="w3_open()">
          <i onclick="document.getElementById('findcart').style.display='block'" class="fa fa-search"></i>

        </a>
        <!-- Bottom Bar Start -->
      <div class="w3-bar-item  bottom-bar">
        <div id="findcart" class="w3-modal-find w3-padding-32 w3-right">
          <div class="search" class="w3-container  ">
            <input type="text" value="BXD - ALEX OVERPRINT TEES/BLACK">
          </div>
        </div>
      </div>
      <!-- Bottom Bar End -->
